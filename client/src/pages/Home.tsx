...
export default function Home() {
  ...
  const conciergeServices = [
    {
      number: '01',
      title: 'ЧАСТЕН СКИ ИНСТРУКТОР',
      desc: 'Сертифициран инструктор само за вас. Пистите на Пампорово като ваша лична сцена.',
      image: HERO_IMAGE,
    },
    {
      number: '02',
      title: 'ШЕФ В АПАРТАМЕНТА',
      desc: 'Мишленов готвач приготвя вечерята директно в апартамента ви. Гастрономия на 1800м.',
      image: CHEF_IMAGE,
    },
    {
      number: '03',
      title: 'СПА ТРАНСФЕР',
      desc: 'Частен трансфер до най-добрите СПА центрове в региона. Релакс след перфектния ски ден.',
      image: SPA_IMAGE,
    },
    {
      number: '04',
      title: 'ХЕЛИКОПТЕРЕН ТРАНСФЕР',
      desc: 'Пристигнете с хеликоптер директно до Пампорово. Входът в планинския лукс.',
      image: BEDROOM_IMAGE,
    },
    {
      number: '05',
      title: 'ВИНО И ДЕГУСТАЦИЯ',
      desc: 'Куриран избор от български и световни вина. Сомелиер на ваше разположение.',
      ...
      >
        <div style={{
          ...
          <h2 style={{
            ...
            Преживяванията, <span style={{ color: 'rgba(234,234,234,0.3)' }}>включени в цената.</span>
          </h2>
        </div>
