...
export default function Home() {
  ...
  const conciergeServices = [
    ...
    },
    {
      number: '04',
      title: 'ЗИМЕН ТУРИЗЪМ',
      desc: 'Ски и сноуборд училище, нощно каране и преходи с моторни шейни през заснежените Родопи.',
      image: BEDROOM_IMAGE,
    },
    {
      number: '05',
      title: 'ЛЕТЕН ТУРИЗЪМ',
      desc: 'Велопарк Пампорово, пешеходни преходи до вр. Снежанка, конна езда и приключенски парк.',
      ...
      >
        <div style={{
          ...
          <h2 style={{
            ...
            Преживяванията, включени в цената. — <span style={{ color: '#C5A059' }}>НАШИТЕ ПРЕДЛОЖЕНИЯ</span>
          </h2>
        </div>
